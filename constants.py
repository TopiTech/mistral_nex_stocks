...
SSE_YAHOO_FETCH_MARKET_CLOSED_SLEEP = _env_float("MNS_SSE_YAHOO_FETCH_MARKET_CLOSED_SLEEP", 300.0, 30.0, 3600.0)
SSE_YAHOO_FETCH_MARKET_OPEN_SLEEP = _env_float("MNS_SSE_YAHOO_FETCH_MARKET_OPEN_SLEEP", 90.0, 10.0, 600.0)
SSE_YAHOO_FETCH_NO_LISTENER_SLEEP = _env_float("MNS_SSE_YAHOO_FETCH_NO_LISTENER_SLEEP", 60.0, 10.0, 600.0)
