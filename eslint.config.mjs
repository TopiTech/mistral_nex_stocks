export default [
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        sendChat: "readonly",
        streamChatReply: "readonly",
        chatPollingReply: "readonly",
        ...
        ObservatoryDataAdapter: "readonly",
        ObservatoryState: "readonly",
        OrbitRenderer: "readonly",
        GestureController: "readonly",
        TemporalController: "readonly",
        ConstellationController: "readonly",
        AiDiveController: "readonly",
        AccessibilityController: "readonly",
      },
    },
    rules: {
      "no-unused-vars": [
